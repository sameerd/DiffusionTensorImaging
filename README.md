# Single Shell Free Water Elimination Model 

This is a python implementation of a Single Shell Free Water elimination model the follows the following papers.
